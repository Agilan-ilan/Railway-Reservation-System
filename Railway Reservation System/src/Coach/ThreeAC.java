...
public class ThreeAC extends Coach implements ICoach{


	
	public ThreeAC(String coachName, int coachCapacity,int coachSeatStartingNo,int coachSeatEndingNo, int seatReservationCount,
			boolean isAC) {
		setClassCoachName(coachName);
		setClassCoachType("THREE-AC");
