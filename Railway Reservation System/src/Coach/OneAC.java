...
public class OneAC extends Coach implements ICoach{

	

	public OneAC(String coachName, int coachCapacity,int coachSeatStartingNo,int coachSeatEndingNo, int seatReservationCount,
			boolean isAC) {
		setClassCoachName(coachName);
		setClassCoachType("ONE-AC");
